...
function EditProfile() {
  ...
  profileFields.forEach((field) => {
    fieldState[field.id as keyof typeof fieldState] = user[field.id];
  });
  ...
  return (
    <div className="bg-light-bg dark:bg-dark-frame-bg min-h-screen  lg:ml-28">
      ...
      <div className=" lg:px-4 border bg-white dark:border-dark-bg  dark:bg-dark-bg dark:text-white w-[94vw] md:w-[96vw] lg:w-[75%] h-fit  my-6 rounded-lg ml-auto mr-32">
        <div className="px-4">
          <Button
            variant="default"
            size="md"
            ...
            {profileFields.map((field) => (
              <Input
                ...
                customClass={`dark:bg-dark-bg ${
                  field.disabled &&
                  "bg-gray-200 text-gray-500  border-gray-400 focus:ring-gray-200  hover:cursor-not-allowed"
                }`}
